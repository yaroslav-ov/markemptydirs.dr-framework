...
{
    [Serializable]
    public struct Touple4<A,B,C,D> : IEnumerable
    {
        private readonly object[] _elements;
        
        public Touple4(A first, B second, C third, D fourth)
        {
        ...
        {
            if (null == obj || !(obj is Touple4<A,B,C,D>))
                return false;
            var other = (Touple4<A,B,C,D>)obj;
